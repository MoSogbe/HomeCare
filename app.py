...
from resources.user_types import blp as UserTypeSchema
...
def create_app(db_url=None):
    ...
    app.config["SQLALCHEMY_DATABASE_URI"] = db_url or os.getenv("DATABASE_URL","mysql://root:123456@localhost/homecare")
    ...
    api.register_blueprint(UserTypeSchema)
